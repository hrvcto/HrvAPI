define(function(){
  function showInfo(cesiumWidget, options){
    ...
    var html = [
        '<div class="mask-c" id="showInfoWindowC" style="width:' + w + 'px; height:' + h + 'px; left:' + x + 'px;">',
          '<iframe src="' + options.url + '" width="' + w + '" height="' + h + '" frameborder="0"></iframe>',
        '</div>'];

    var htmlFragment = document.createElement('div');
    htmlFragment.id = 'showInfoWindow';
    ...
    var infoWindow = document.getElementById('showInfoWindow');
    var infoWindowC = document.getElementById('showInfoWindowC');
